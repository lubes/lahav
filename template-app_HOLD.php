        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-8 offset-md-2">
                <div class="entry text-center fadein">
                    <?php echo the_field('app_description');?>
                </div>
            </div>
        </div>
        <div class="icons">
...
<section class="doc image-bg" style="background:url('<?php echo the_field('download_image');?>') no-repeat center;background-size:cover;">
    <div class="container">
        <div class="cta-entry fadein">
            ...
            <a href="<?php echo the_field('download_link');?>" target="_blank" class="btn btn-green btn-round">DOWNLOAD</a>
        </div>
    </div>
</section>
        ...
        <div class="app-module">
            <div class="app-img desktop-mod" id="desktop_image">
                <?php if( have_rows('module_2_sections') ): $i = 4; while ( have_rows('module_2_sections') ) : the_row();  $i++; ?>
                    <div class="image-holder desktop-mod <?php if($i==5) { echo 'active'; } ?>" id="module-<?php echo $i;?>">
                    <div class="desktop-frame">
                        <img src="<?php echo get_template_directory_uri();?>/dist/images/desktop-frame.png" class="img-fluid frame-img"  />
                        <img src="<?php echo the_sub_field('image');?>" class="img-fluid desktop-screen" />
                    </div>     
                    </div>
            ...
            <div class="row">
                <?php if( have_rows('module_2_sections') ): $i = 4; while ( have_rows('module_2_sections') ) : the_row();  $i++; ?>
                    ...
                    <a class="app-link fadein desktop-mod <?php if($i == 6 || $i== 8) { echo 'righty'; } ?> <?php if($i==5) { echo 'active'; } ?>" data-id="module-<?php echo $i;?>" href="#desktop_image">
                        <div class="animated-line <?php if($i == 6 || $i== 8) { echo 'right-line'; } ?>"></div>
                        <?php echo the_sub_field('copy');?>
                    </a>
                    </div>
                <?php endwhile;endif;?>
...
<section class="doc testimonials green-bg">
    <div class="container">
        <figure class="testimonial-img fadein">
            <img src="<?php echo the_field('testimonial_image', 13);?>" class="img-fluid rounded-circle" />
        </figure>
        <p class="testimonial fadein">"<?php echo the_field('testimonial_copy', 13);?>"</p>
        <p class="fadein"><?php echo the_field('testimonial_source', 13);?></p>
    </div>
</section>
...
<section class="doc">
    <div class="container">
        <div class="text-center">
            <h1 class="bold">Browse LaHaVs Interface:</h1>
        </div>
